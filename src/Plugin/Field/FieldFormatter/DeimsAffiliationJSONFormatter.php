...
/**
 * Plugin implementation of the 'DeimsAffiliationJSONFormatter' formatter.
 *
 * @FieldFormatter(
 *   id = "deims_affiliation_json_formatter",
 *   label = @Translation("Deims Affiliation JSON Formatter"),
 *   field_types = {
...
class DeimsAffiliationJSONFormatter extends FormatterBase {
